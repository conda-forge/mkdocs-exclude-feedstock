About mkdocs-exclude-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mkdocs-exclude-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15529&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mkdocs-exclude-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mkdocs-exclude` can be installed with `conda`:
...
```
mamba install mkdocs-exclude
```

It is possible to list all of the versions of `mkdocs-exclude` available on your platform with `conda`:
...
```
mamba search mkdocs-exclude --channel conda-forge
```
...
mamba repoquery search mkdocs-exclude --channel conda-forge

# List packages depending on `mkdocs-exclude`:
mamba repoquery whoneeds mkdocs-exclude --channel conda-forge

# List dependencies of `mkdocs-exclude`:
mamba repoquery depends mkdocs-exclude --channel conda-forge
```
